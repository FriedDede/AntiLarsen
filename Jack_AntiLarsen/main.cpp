...
static void connectPort(LADSPA_Handle Instance, unsigned long Port, LADSPA_Data * DataLocation) {
    switch (Port) {
        ...
        case 1:
            ...
            break;
        case 2:
            if (analyzer != nullptr) analyzer->setJackBuffer(DataLocation);
            break;
        default:
            break;
    }
...
public:
    ...
    StartupShutdownHandler() {
        ...
        LADSPA_PortRangeHint * psPortRangeHints;
            ...
            g_psDescriptors ->Label = localStrdup("sine_faaa");
            g_psDescriptors ->Name = localStrdup("Sine Oscillator (Freq:audio, Amp:audio)");
